...
from sqlalchemy import func,DateTime,String,Integer,Index,ForeignKey,Text
...
class Categories(Base):
    ...
    name: Mapped[str] = mapped_column(String(255),unique=True,nullable=False,comment="新闻标题")
    sort_order: Mapped[int] = mapped_column(Integer,default=0,nullable=False,comment="排序")

    def __repr__(self):
        return f"<Categories(name={self.name},sort_order={self.sort_order})>"
